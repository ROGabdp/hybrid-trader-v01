...
3. 執行微調 (Fine-tuning) - 較少步數

與 V3 的差異：
- Buy Agent Fine-tune: 1M -> 200K 步
- Sell Agent Fine-tune: 300K -> 100K 步
...
def run_finetuning():
    print("\n" + "=" * 60)
    print("Step C: Fine-tuning (Lightweight)")
    print("=" * 60)
    print(f"  Buy Agent:  {FINETUNE_BUY_STEPS:,} steps (lightweight)")
    print(f"  Sell Agent: {FINETUNE_SELL_STEPS:,} steps (lightweight)")
    print(f"  Output:     {V4_MODELS_PATH}")
    print("=" * 60)
    ...
    if os.path.exists(cache_path):
        ...
        print("[Compute] Downloading ^TWII...")
    ...
    print(f"\n[Training] Starting fine-tuning (lightweight)...")
...
V4 Features (vs V3):
   - Buy Fine-tune: 1M -> 200K steps (lighter)
   - Sell Fine-tune: 300K -> 100K steps (lighter)
   - Retains more pre-training knowledge
...
def main():
    print("=" * 60)
    print("V4 Model Training Script (Lightweight Fine-tuning)")
    print("   Buy Fine-tune: 200K steps | Sell Fine-tune: 100K steps")
    print("=" * 60)
