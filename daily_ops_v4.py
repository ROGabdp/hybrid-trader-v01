...
"""
================================================================================
Daily Operations V4 - 單一策略每日維運腳本 (輕量化微調版本)
================================================================================
專為 V4 模型設計的每日維運腳本 (輕量化 Fine-tune)
...
def main():
    ...
    print("=" * 60)
    print(f"🚀 V4 每日維運系統 (輕量化) - {date_str}")
    print("=" * 60)
